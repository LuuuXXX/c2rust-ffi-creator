...
| ⚠ 1a | Step 1 完成后 | 符号对账：binary nm/objdump ↔ 头文件声明逐行 diff，差异全部清零 | `abi-freeze-checklist.md` 第 2 节 | **是** |
...
| ⚠ 5 | Step 6a 完成后 | 接口重设计工作坊三层分析（数据类型层→实现依赖层→顶层接口架构） | `phase2-change-proposal.md` 工作坊节 | **是** |
